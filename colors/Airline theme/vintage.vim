...
let s:N3 = [ s:whit[0]  , '#002b36' , 188 , 234 ] " C section
" insert mode
...
let g:airline#themes#vintage#palette.replace_modified = {
   ...
   \ } 
let s:IA = [ s:N2[0], s:N2[1], s:N2[2], s:N2[3], '' ] "inactive mode airline_a
let s:IB = [ s:N2[0], s:N2[1], s:N2[2], s:N2[3], '' ] "inactive mode airline_b
...
let g:airline#themes#vintage#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
      \ [ s:whit[0] , '#00AFA2' , 255 , 37  , ''     ],
      \ [ s:whit[0] , '#008787' , 255 , 30  , ''     ],
      \ [ s:gry0[0] , s:whit[0] , 234 , 255 , ''     ])
